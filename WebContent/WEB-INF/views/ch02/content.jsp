...
<html>
	...
	<body>	
		...
		<br>
			<h4>[요청 매핑]</h4>
			<p>
				<a href = "getMethod" class = "btn btn-primary">get방식 테스트</a><br>
			</p>
			<p>
				<a href = "<%=application.getContextPath()%>/ch02/content">Get Testing</a>
			</p>
				<!-- href = "getMethod"는 ch02/content/getMethod 와 같은 형식이다 -->
				<form action="postMethod" method = "post">
					<input type = "submit" value = "postMethod" class = "btn btn-primary">
				</form>
			<p>
				<a href = "joinForm" class = "btn btn-primary">get방식 Join Form</a><br>
			</p>
